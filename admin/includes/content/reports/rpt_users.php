...
?>
			<div id="content" style="width: calc(100% - 340px);">
                ...
                <div class="row">
                   ...
                   <!-- <div class="col-sm-2">
                    	<h2>
                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=users&tab=Add'">Add New<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i></button>
                    	</h2>
                    </div>-->
                </div>
