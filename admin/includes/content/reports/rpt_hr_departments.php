<?php 
	...
	$list = $HR_Department->get_department_list($param)['data'];
?>
<?php 
...
?>
			<div id="content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">HR.Department Management</li>
					</ul><!-- /.breadcrumb -->
				</div>
				<?php 
				if($_GET['tab']=="View")
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <h3>HR.Department > View</h3>
                    </div>
                  <!--  <div class="col-sm-2">
                    	<h2>
                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=hr_departments&tab=Add'">Add New<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i></button>
                    	</h2>
                    </div>-->
                </div>
									...
									<div class="col-xs-12">
										<table id="tblDataTable" class="table table-striped table-bordered table-hover">
                                            ...
                                            <?php
												...
												<!--	<td>
														<a id="edit" class="green" href="?url=hr_departments&tab=Edit&id=<?= $department['id'] ?>" title="Edit">
														<i class="ace-icon fa fa-pencil bigger-130"></i>Edit</a> |<a href="./form_handler.php?action=manageHRDepartment&type=Delete&id=<?= $department['id'] ?>&accessToken=<?= $_SESSION[$_SESSION_ID]['accessToken'] ?>"  >
	...
	if($tab=="Edit")
	{
		...
		$details = $HR_Department->get_department_details($param)['data'];
	} 
	?>             
		<div class="row">
					<div class="row" style="padding:0 30px;">
	                    <div class="col-sm-10">
	                        <h3>HR.Department > <?php echo $purifier->purify($tab); ?></h3>
	                    </div>
	                    <div class="col-sm-2">
	                    	<h2>
	                    		<button style="float:right"  type="button" class="btn btn-info" onclick="window.location='./?url=hr_departments&tab=View'">Back<i class="ace-icon fa fa-reply icon-on-right bigger-110"></i></button>
	                    	</h2>
	                    </div>
	                </div>
							<div class="col-xs-9">
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action='form_handler.php?action=manageHRDepartment' method="post">
