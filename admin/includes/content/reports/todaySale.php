            ...
            <input class="form-control datepicker" data-date-format="mm/dd/yyyy" id="startDate">
              ...
              <!-- <div class="col-sm-3"><div class="form-group">
                 ...
                 <div class="col-sm-3"><div class="form-group">
                  ...
                  <input  class="form-control btn-default" style="width: 50%;margin:auto;margin-top:25px; border:0px; " type="button" onclick="getTodayFilterRecords('userId')" value="Filter">
                </div></div>
