 			  <?php $param = array();
                $param['conditionParam']['param']['banner_index_value'] = 2;
...
<div class="header" style="background-image:url('<?=$_PATH['websiteRoot'].'/'.$bannerDetails->banner_image?>'); height: 75px !important;">
		<div class="container">
			<div class="heder-top">
